...
/**
 * Shared placeholder for an Operations domain that only exists as a rail
 * entry today — the rail/nav shape is ported 1:1 from cs-tools/apps/csm-portal
 * (see csmNavItems.ts's "operations" section), but the domains themselves
 * (Service requests, Change requests, Problem management, Outages) have no
 * ported page yet; only Cases/Incidents (see CsmCaseListPage) is real.
 *
