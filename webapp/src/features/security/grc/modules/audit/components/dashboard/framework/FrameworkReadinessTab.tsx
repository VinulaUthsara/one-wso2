...
import EmptyState from "@features/security/grc/components/empty-state/EmptyState";
...
import type { Audit, AuditControl, ControlListResponse } from "@features/security/grc/modules/audit/types/audit";
import type { ScopeRollup } from "@features/security/grc/modules/audit/types/framework";
import { computeFrameworkRollups } from "@features/security/grc/modules/audit/utils/frameworkRollup";
