...
// Lifts a card off the canvas in dark mode. The source used literal greys; these
// are the theme's own paper and divider, so the treatment survives a theme
// change instead of pinning one theme's palette into every card.
